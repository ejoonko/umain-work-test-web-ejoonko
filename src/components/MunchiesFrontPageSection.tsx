...
import { DeliveryTimeRange, Filter, FullRestaurant, RestaurantFilters } from "@/modules/types"
...
export function MunchiesFrontPageSection({ restaurants, filters }: MunchiesFrontPageSectionProps) {
    ...
    const [activeDeliveryTimeFilters, setActiveDeliveryTimeFilters] = useState<DeliveryTimeRange[]>([])
    const [activePriceRangeFilters, setActivePriceRangeFilters] = useState<string[]>([])

    return (
        <>
            <div className="flex flex-col gap-10">
                <FoodFiltersSection availableFilters={availableFilters} activeFoodFilters={activeFoodFilters} setActiveFoodFilters={setActiveFoodFilters} />
...
function getAvailableFilters(restaurants: FullRestaurant[], filters: Filter[]): RestaurantFilters {
